...
TR opt: float-complex-float.rkt 20:3 (* -0.9263371220283309 3/2 (make-rectangular +inf.0 0.7692234292042541)) -- unboxed binary float complex
TR opt: float-complex-float.rkt 20:30 (make-rectangular +inf.0 0.7692234292042541) -- make-rectangular elimination
TR opt: float-complex-float.rkt 20:6 -0.9263371220283309 -- float in complex ops
TR opt: float-complex-float.rkt 21:0 (/ 2.3454025 (flmin (real->double-flonum 1.797693134862315e+308) (real->double-flonum -1.2848677e+32)) (make-rectangular +nan.0 0.0)) -- unboxed binary float complex
TR opt: float-complex-float.rkt 21:105 (make-rectangular +nan.0 0.0) -- make-rectangular elimination
TR opt: float-complex-float.rkt 21:15 (flmin (real->double-flonum 1.797693134862315e+308) (real->double-flonum -1.2848677e+32)) -- binary float
TR opt: float-complex-float.rkt 21:15 (flmin (real->double-flonum 1.797693134862315e+308) (real->double-flonum -1.2848677e+32)) -- float in complex ops
TR opt: float-complex-float.rkt 21:22 (real->double-flonum 1.797693134862315e+308) -- float to float
TR opt: float-complex-float.rkt 21:3 2.3454025 -- float in complex ops
TR opt: float-complex-float.rkt 21:67 (real->double-flonum -1.2848677e+32) -- float to float
TR opt: float-complex-float.rkt 22:3 (+ (make-polar 4.8063810141303426e-57 -1.9082319) -0.8414709848078965) -- unboxed binary float complex
TR opt: float-complex-float.rkt 22:55 -0.8414709848078965 -- float in complex ops
TR opt: float-complex-float.rkt 22:6 (make-polar 4.8063810141303426e-57 -1.9082319) -- make-rectangular elimination
TR opt: float-complex-float.rkt 23:20 (max (exact-round 2) (exact-round 5/4)) -- non float complex in complex ops
TR opt: float-complex-float.rkt 23:3 (+ 1524588600000.0 (max (exact-round 2) (exact-round 5/4)) (tanh (make-rectangular 1.4291365847030308e-64 -0.76987815))) -- unboxed binary float complex
TR opt: float-complex-float.rkt 23:6 1524588600000.0 -- float in complex ops
TR opt: float-complex-float.rkt 23:60 (tanh (make-rectangular 1.4291365847030308e-64 -0.76987815)) -- unbox float-complex
TR opt: float-complex-float.rkt 23:66 (make-rectangular 1.4291365847030308e-64 -0.76987815) -- binary float comp
TR opt: float-complex-float.rkt 24:16 0.9845773 -- float in complex ops
TR opt: float-complex-float.rkt 24:28 (make-rectangular 3 0.0) -- make-rectangular elimination
TR opt: float-complex-float.rkt 24:3 (* (min 3/4) 0.9845773 (make-rectangular 3 0.0)) -- unboxed binary float complex
...
TR opt: float-complex-float.rkt 25:20 (floor -2.2441852) -- float in complex ops
TR opt: float-complex-float.rkt 25:20 (floor -2.2441852) -- unary float
TR opt: float-complex-float.rkt 25:3 (/ 3.2993203e+37 (floor -2.2441852) (make-polar 0.42484267570553375 4.940078147009648)) -- unboxed binary float complex
TR opt: float-complex-float.rkt 25:41 (make-polar 0.42484267570553375 4.940078147009648) -- make-rectangular elimination
TR opt: float-complex-float.rkt 25:6 3.2993203e+37 -- float in complex ops
TR opt: float-complex-float.rkt 26:0 (/ -5 2/7 (make-polar -0.0 (fltan (real->double-flonum -3.833043e+21)))) -- unboxed binary float complex
TR opt: float-complex-float.rkt 26:10 (make-polar -0.0 (fltan (real->double-flonum -3.833043e+21))) -- make-rectangular elimination
TR opt: float-complex-float.rkt 26:27 (fltan (real->double-flonum -3.833043e+21)) -- unary float
TR opt: float-complex-float.rkt 26:3 -5 -- non float complex in complex ops
TR opt: float-complex-float.rkt 26:34 (real->double-flonum -3.833043e+21) -- float to float
TR opt: float-complex-float.rkt 26:6 2/7 -- non float complex in complex ops
TR opt: float-complex-float.rkt 27:0 (/ (+ (exact-round 1.8655746e+35) (exact-round 1)) 2.0324421e-21 (make-rectangular 4 1.7976931348623157e+308)) -- unboxed binary float complex
TR opt: float-complex-float.rkt 27:3 (+ (exact-round 1.8655746e+35) (exact-round 1)) -- non float complex in complex ops
TR opt: float-complex-float.rkt 27:34 (exact-round 1) -- non float complex in complex ops
TR opt: float-complex-float.rkt 27:51 2.0324421e-21 -- float in complex ops
TR opt: float-complex-float.rkt 27:6 (exact-round 1.8655746e+35) -- non float complex in complex ops
TR opt: float-complex-float.rkt 27:6 (exact-round 1.8655746e+35) -- non float complex in complex ops
...
TR opt: float-complex-float.rkt 30:0 (+ (floor (+ (exact-round -25.263502) (exact-round -1/2))) (- 0.0 16 (make-rectangular -inf.0 0.0)) +nan.0) -- unboxed binary float complex
TR opt: float-complex-float.rkt 30:102 +nan.0 -- float in complex ops
TR opt: float-complex-float.rkt 30:3 (floor (+ (exact-round -25.263502) (exact-round -1/2))) -- non float complex in complex ops
...
TR opt: float-complex-float.rkt 31:3 (- 0.8214678 3 -741.732021720279+inf.0i) -- unboxed binary float complex
TR opt: float-complex-float.rkt 31:6 0.8214678 -- float in complex ops
TR opt: float-complex-float.rkt 32:100 (log 7.4109846876187e-323) -- unary float
TR opt: float-complex-float.rkt 32:11 -0.17853218 -- float in complex ops
TR opt: float-complex-float.rkt 32:127 (abs -inf.0) -- unary float
TR opt: float-complex-float.rkt 32:26 (bitwise-ior (max (exact-round 3)) (exact-round 0.0)) -- binary fixnum
TR opt: float-complex-float.rkt 32:26 (bitwise-ior (max (exact-round 3)) (exact-round 0.0)) -- non float complex in complex ops
TR opt: float-complex-float.rkt 32:3 (- (+ 1 -0.17853218) (bitwise-ior (max (exact-round 3)) (exact-round 0.0)) (make-rectangular (log 7.4109846876187e-323) (abs -inf.0))) -- unboxed binary float complex
TR opt: float-complex-float.rkt 32:39 (max (exact-round 3)) -- unary number
TR opt: float-complex-float.rkt 32:6 (+ 1 -0.17853218) -- binary float
TR opt: float-complex-float.rkt 32:6 (+ 1 -0.17853218) -- float in complex ops
