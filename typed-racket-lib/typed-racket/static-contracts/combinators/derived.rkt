...
(define mutable-hash?/sc (and/sc (flat/sc #'hash?)
                                 (flat/sc #'(λ (h) (not (immutable? h))))
                                 (flat/sc #'(λ (h) (not (hash-weak? h))))))
(define immutable-hash?/sc (and/sc (flat/sc #'hash?) (flat/sc #'immutable?)))
(define weak-hash?/sc (and/sc (flat/sc #'hash?) (flat/sc #'hash-weak?)))
