...
[set-empty? (-poly (e) (-> (-list-set e) B))]
[set-count (-poly (e) (-> (-list-set e) -Index))]
[set-member? (-poly (e) (-> (-list-set e) e B))]
[set-first (-poly (e) (-> (-list-set e) e))]
...
[set-map (-poly (e b) (-> (-list-set e) (-> e b) (-lst b)))]
[set-for-each (-poly (e b) (-> (-list-set e) (-> e b) -Void))]
[generic-set? (asym-pred Univ B (-PS -tt (-not-type 0 (-list-set Univ))))]
