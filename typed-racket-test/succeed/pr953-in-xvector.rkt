...
(check-equal? (sequence->list (in-flvector (flvector 1.0 2.0 3.0 4.0) 3 -1 -2)) (list 4.0 2.0))

(check-equal? (sequence->list (in-fxvector (fxvector 1 2 3 4) 3 -1 -2)) (list 4.0 2.0))

(check-equal? (sequence->list (in-extflvector (extflvector 1.0t0 2.0t0 3.0t0 4.0t0) 3 -1 -2)) (list 4.0t0 2.0t0))