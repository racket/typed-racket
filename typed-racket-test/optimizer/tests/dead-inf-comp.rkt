#;#;
#<<END
TR info: dead-inf-comp.rkt 56:41 displayln -- hidden parameter
...
TR missed opt: dead-inf-comp.rkt 56:0 (for: ((i (in-range 5 +inf.0 2)) (j 3)) (displayln i)) -- generic comparison -- caused by: 56:0 (for: ((i (in-range 5 +inf.0 2)) (j 3)) (displayln i))
...
TR opt: dead-inf-comp.rkt 56:0 (for: ((i (in-range 5 +inf.0 2)) (j 3)) (displayln i)) -- dead else branch
TR opt: dead-inf-comp.rkt 56:0 (for: ((i (in-range 5 +inf.0 2)) (j 3)) (displayln i)) -- dead else branch
TR opt: dead-inf-comp.rkt 56:0 (for: ((i (in-range 5 +inf.0 2)) (j 3)) (displayln i)) -- dead else branch
TR opt: dead-inf-comp.rkt 56:36 3 -- in-range
